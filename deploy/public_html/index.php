    ...
    <section class="hero" id="home">
        <div class="container hero-grid">
            ...
            <div class="hero-card">
                ...
                <!-- SECURE FORM with CSRF Protection (OWASP #4) -->
                <form class="hero-quick-form" id="quickQuoteForm" action="/php/process_form.php" method="POST" data-tracking="hero-callback-form">
                    <!-- CSRF Token (Security) -->
                    ...
                    <div class="form-group">
                        ...
                        <select id="quickService" name="service" required>
                            ...
                            <option value="pallets">I need to BUY pallets</option>
                            <option value="pallets">I have pallets TO SELL</option>
                            ...
                            <option value="milling">Lumber / Custom milling</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="quickName">Your name</label>
                        <input type="text" id="quickName" name="name" placeholder="John Smith" required maxlength="100">
                    </div>
                    <div class="form-group">
                        <label for="quickPhone">Your phone number</label>
                        <input type="tel" id="quickPhone" name="phone" placeholder="(219) 555-1234" required pattern="[0-9\-\.\s()]{10,15}">
                    </div>
                    <div class="form-group">
                        <label for="quickEmail">Your email</label>
                        <input type="email" id="quickEmail" name="email" placeholder="you@example.com" required>
                    </div>
                    <div class="form-group">
                        <label for="quickMessage">Message (optional)</label>
                        <textarea id="quickMessage" name="message" placeholder="Any details..." rows="2" maxlength="1000"></textarea>
                    </div>
